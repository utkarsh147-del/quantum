...
def open_settings_window():
    ...
    IBMQ.enable_account('acf9daa7f84a0a81b6e1e1b585572ecd06633597b9b0f1ad383dd8c3e620cf3e9729fc31c26696042445fd257e7ff73135f764f4e47e7ef3e4762c7fe0a19c57') # Enter your API token here
    ...
    def res():
        ...
        result_dict = factors.factor(N=N, a=2) # Where N is the integer to be factored
        prime_factors = result_dict.factors
        result_label.config(text='Prime factors: {}'.format(prime_factors))
    ...
    button_1 = tk.Button(root, text="1", padx=40, pady=20, bg="lightblue", bd=4, command=lambda: button_click(1))
    button_2 = tk.Button(root, text="2", padx=40, pady=20, bg="lightblue", bd=4, command=lambda: button_click(2))
    button_3 = tk.Button(root, text="3", padx=40, pady=20, bg="lightblue", bd=4, command=lambda: button_click(3))
    button_4 = tk.Button(root, text="4", padx=40, pady=20, bg="lightblue", bd=4, command=lambda: button_click(4))
    button_5 = tk.Button(root, text="5", padx=40, pady=20,  bg="lightblue", bd=4,command=lambda: button_click(5))
    button_6 = tk.Button(root, text="6", padx=40, pady=20, bg="lightblue", bd=4, command=lambda: button_click(6))
    button_7 = tk.Button(root, text="7", padx=40, pady=20, bg="lightblue", bd=4, command=lambda: button_click(7))
    button_8 = tk.Button(root, text="8", padx=40, pady=20, bg="lightblue", bd=4, command=lambda: button_click(8))
    button_9 = tk.Button(root, text="9", padx=40, pady=20, bg="lightblue", bd=4, command=lambda: button_click(9))
    button_0 = tk.Button(root, text="0", padx=40, pady=20, bg="lightblue", bd=4, command=lambda: button_click(0))
    button_clea = tk.Button(root, text="Clear", padx=79, pady=20, bg="lightgray", bd=4, command=button_clear)
    button_delet = tk.Button(root, text="Delete", padx=70, pady=20, bg="lightgray", bd=4, command=button_delete)
    button_res = tk.Button(root, text="Result", padx=70, pady=20, bg="lightgray", bd=4, command=res)
    ...
    button_clea.grid(row=4, column=0)
    button_delet.grid(row=4, column=2)
    button_res.grid(row=4,column=1)

    root.mainloop()

        # Place widgets in the settings window
...
title_label = tk.Label(window, text="Welcome to the Uira Quantum", font=("Helvetica", 24), bg='#3D3D3D', fg='white')
title_label.pack(pady=50)

    # Add buttons for opening the main window and settings window
main_button = tk.Button(window, text="Quantum Gate Visualizer", font=("Helvetica", 18), bg='white', fg='#3D3D3D', command=open_main_window)
settings_button = tk.Button(window, text="Shor's Algo Prime factor ", font=("Helvetica", 18), bg='white', fg='#3D3D3D', command=open_settings_window)
